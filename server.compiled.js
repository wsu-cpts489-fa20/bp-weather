      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            return _context10.abrupt("return", res.status(400).send("POST request on /histories formulated incorrectly." + "Body must contain all 8 required fields: date, location, condition, visibility, temperature, humidity, windSpeed, windDirection."));
          ...
          case 12:
            ...
            return _context10.abrupt("return", res.status(400).send("Unexpected error occurred when adding histories" + " to database: " + _context10.t0));
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return _context11.abrupt("return", res.status(400).send("POST request on /weathers formulated incorrectly." + "Body must contain all 3 required fields: id, latitude, longitude."));
          ...
          case 10:
            ...
            return _context11.abrupt("return", res.status(400).send("Unexpected error occurred when adding weather" + " to database: " + _context11.t0));
    ...
    return _regeneratorRuntime["default"].wrap(function _callee12$(_context12) {
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 9:
            return _context12.abrupt("return", res.status(200).json(JSON.stringify(thisUser.rounds)));
    ...
    return _regeneratorRuntime["default"].wrap(function _callee13$(_context13) {
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 9:
            return _context13.abrupt("return", res.status(200).json(JSON.stringify(thisUser.histories)));
    ...
    return _regeneratorRuntime["default"].wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 9:
            return _context14.abrupt("return", res.status(200).json(JSON.stringify(thisUser.weathers)));
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            ...
            _context15.t0 = _regeneratorRuntime["default"].keys(bodyObj);
          ...
          case 6:
            ...
            return _context15.abrupt("return", res.status(400).send("rounds/ PUT request formulated incorrectly." + "It includes " + bodyProp + ". However, only the following props are allowed: " + "'date', 'course', 'type', 'holes', 'strokes', " + "'minutes', 'seconds', 'notes'"));
          ...
          case 23:
            ...
            return _context15.abrupt("return", res.status(400).send("Unexpected error occurred when updating round in database: " + _context15.t2));
      ...
      while (1) {
        switch (_context18.prev = _context18.next) {
          ...
          case 9:
            ...
            return _context18.abrupt("return", res.status(400).send("Unexpected error occurred when deleting weather from database: " + _context18.t0));
